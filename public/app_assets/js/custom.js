...
//  Client logo Carousel function by = owl.carousel.js ========================== //
	...
	function Dropzone_infut_file(){
		if(jQuery('#demo-uploads').length){
		var dropzone = new Dropzone('#demo-uploads', {
		...
		// Now fake the file uploads, since GitHub does not handle file uploads
		// and returns a 404
